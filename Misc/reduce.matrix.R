...
#' @param distance which distance to consider (passed to vegan::vegdist, default = "gower")
#' @param by.row Whether to do it by rows (TRUE - default), or by columns (FALSE)
#' @param verbose Whether to do be verbose (TRUE) or not (FALSE, default)
#' 
#' @examples
#' set.seed(1)
#' ## A 10*5 matrix
