...
##########################
#SYNTAX :
#sh TEM_mastsim.sh [<Living Species> <Input matrix>] <Molecular characters> <Morphological characters> <Evolutionary model>
#with
...
then
    ...
    #Morphological matrix comes first
